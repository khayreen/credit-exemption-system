...
{
    /**
     * Display a listing of the applications for the lecturer.
     */
    public function index()
    {
        ...
        return view('lecturer.dashboard', compact('applications', 'stats'));
    }
    ...
    public function show(ExemptionApplication $application)
    {
        ...
        // Pre-qualified subjects: originally 'exempted' by OCR, may have lecturer decisions
        ...
        // Manual review subjects: originally not exempted by OCR, may have lecturer decisions  
        ...
        return view('lecturer.show', compact('application', 'subjects', 'exemptedSubjects', 'nonExemptedSubjects'));
    }
    ...
    public function processSubjectDecision(Request $request, ExemptionApplication $application, ApplicationSubject $subject)
    {
        try {
            ...
            $actionType = $request->decision === 'Undo' ? 'Lecturer Decision Undo' : 'Lecturer Decision';
            $details = [
            ...
            // Check if all subjects have been processed by lecturer
            ...
            Log::error('Error processing lecturer decision: ' . $e->getMessage(), [
                'subject_id' => $subject->id,
                'application_id' => $application->id,
                'user_id' => Auth::id(),
    ...
    public function processDecisions(Request $request, ExemptionApplication $application)
    {
        ...
        return redirect()->route('lecturer.dashboard')->with('success', 'Decisions have been submitted successfully.');
    }
    ...
    /**
     * Determine the original status for a subject when undoing a lecturer decision.
     */
