...
class EquivalencyRequestController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('student.equivalency_request.create', compact('student', 'campuses'));
    }
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'diploma_program' => 'required|string|max:255',
            'diploma_credit_hours' => 'required|numeric|min:0.5|max:10',
            'suggested_degree_course_code' => 'required|string|max:20',
            'suggested_degree_course_name' => 'required|string|max:255',
            'current_program_code' => 'required|string|max:10',
            'current_program_name' => 'required|string|max:255',
        ...
        try {
            ...
            $programCode = trim($validated['current_program_code']);
            ...
            $equivalencyRequest = CourseEquivalencyRequest::create([
                ...
                'diploma_program' => trim($validated['diploma_program']),
                'diploma_credit_hours' => $validated['diploma_credit_hours'],
                ...
                'current_program_name' => trim($validated['current_program_name']),
                'justification' => null,
            ...
            return redirect()
                ...
                ->with('success', 'Course equivalency request submitted successfully! Resource persons will review your request.');
