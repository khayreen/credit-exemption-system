...
class CDCS230CS110EquivalencySeeder extends Seeder
{
    /**
     * Seed CS110 → CDCS230 course equivalencies (14 courses total)
     * CDCS230: Sarjana Muda Sains Komputer (Kepujian)
     * Note: CDCS230 and CDCS253 share the same equivalency list
     */
    public function run(): void
    {
        ...
        // Find or create the CDCS230 internal CS110 equivalency list
        $list = EquivalencyList::firstOrCreate(
            [
                'program_code' => 'CDCS230',
                'category' => EquivalencyList::CATEGORY_INTERNAL,
                'source_institution' => null,
            ],
            [
                'program_name' => 'Sarjana Muda Sains Komputer (Kepujian)',
        ...
        echo "Adding 14 CS110 → CDCS230 course equivalencies...\n";
        ...
        foreach ($courses as $index => $course) {
            CourseEquivalency::create([
                ...
                'notes' => $course['notes'] ?? 'Official CS110 → CDCS230 equivalency',
            ]);
        ...
        echo "\n✅ Successfully added 14 CS110 → CDCS230 course equivalencies!\n";
