...
<div class="container-fluid px-4 py-3">
    ...
    <div class="aa-page-header mb-4">
        ...
        <div class="aa-header-action">
            <a href="{{ Auth::user()->role == 'academic_advisor' ? route('academic_advisor.course_equivalencies.view') : route('program_coordinator.course_equivalencies.view') }}" class="btn btn-primary">
