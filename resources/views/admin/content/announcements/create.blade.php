...
<style>
    ...
    .type-dot.info { background: var(--info-color); }
    .type-dot.success { background: var(--success-color); }
    .type-dot.warning { background: var(--uitm-amber); }
    .type-dot.danger { background: var(--danger-color); }
...
<div class="form-page">
    <div class="container-fluid">
        ...
        <div class="page-header">
            ...
            <p>Add a new system announcement</p>
                    ...
                    <div class="form-card">
                        ...
                        <div class="form-card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <small class="form-text">Leave empty to start immediately</small>
                            </div>

                            <div class="mb-3">
                                <label class="form-label">End Date</label>
                                <input type="datetime-local" name="ends_at" class="form-control" value="{{ old('ends_at') }}">
                                <small class="form-text">Leave empty for no expiration</small>
                            </div>
