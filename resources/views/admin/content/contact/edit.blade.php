                    ...
                    <div class="form-card-body">
                        <form action="{{ route('admin.content.contact.update', $contact) }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control key-display" value="{{ $contact->key }}" disabled readonly>
                                <small class="form-text">Key cannot be changed after creation</small>
                            </div>
