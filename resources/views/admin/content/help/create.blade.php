...
<div class="form-page">
    <div class="container-fluid">
        ...
        <div class="page-header">
            ...
            <p>Add new help content</p>
            <div class="header-actions">
                <a href="{{ route('admin.content.help.index') }}" class="btn-back">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="form-card">
                        <div class="form-card-header">
                            <h5><i class="fas fa-life-ring"></i>Article Content</h5>
                        </div>
                        <div class="form-card-body">
                            ...
                            <div class="mb-0">
                                ...
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <small class="form-text">You can use HTML for formatting</small>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="form-card">
                        ...
                        <div class="form-card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" name="sort_order" class="form-control sort-order-input" value="{{ old('sort_order', 0) }}" min="0">
                            </div>
