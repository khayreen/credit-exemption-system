...
<body>
    ...
    <div class="login-2fa-container">
        <div class="login-2fa-card">
            <!-- Logo Section -->
            <div class="logo-section">
                <div class="logo">
                    <i class="fas fa-mobile-alt"></i>
                </div>
                <h1 class="login-2fa-title">Two-Factor Authentication</h1>
                <p class="login-2fa-subtitle">Enter the 6-digit code from your authenticator app</p>
                <p class="login-email">Logging in as: {{ $email }}</p>
            </div>
            ...
            <form method="POST" action="{{ route('2fa.login.verify') }}">
                ...
                <button type="submit" class="btn btn-verify">
                    <i class="fas fa-sign-in-alt me-2"></i>Verify and Login
                </button>
            </form>
