...
<head>
    ...
    <title>Confirm Password - UiTM Credit Exemption System</title>
    ...
    <div class="page-wrapper">
        ...
        <div class="image-panel">
            ...
            <div class="image-hero">
                ...
                <h1 class="image-hero-title">Confirm Your Identity</h1>
                <p class="image-hero-desc">
                    For your security, please confirm your password before continuing to access sensitive areas of your account.
                </p>
            </div>
        ...
        <div class="form-panel">
            <div class="form-container">
                <div class="form-header animate-fade-in-up">
                    ...
                    <p class="form-subtitle">Please confirm your password before continuing to this secure area</p>
                </div>
                ...
                <form method="POST" action="{{ route('password.confirm') }}">
                    ...
                    @if (Route::has('password.request'))
                        <a href="{{ route('password.request') }}" class="forgot-link animate-fade-in-up delay-2">
