...
<div class="error-container">
    <div class="error-card">
        <div class="error-code-wrapper">
            <span class="error-code-bg">401</span>
        ...
        <p class="error-message">
            ...
            Please sign in with valid credentials to continue.
        </p>
        ...
        <div class="auth-box">
            ...
            <div class="auth-box-content">
                ...
                <p>This resource requires you to be logged in. Please sign in with your UiTM credentials to access the requested page.</p>
            </div>
        </div>

        <div class="btn-group-error">
            <a href="{{ route('login') }}" class="btn-primary-industrial">
                <i class="fas fa-sign-in-alt"></i>
                Go to Login
            </a>
            <a href="{{ route('home') }}" class="btn-secondary-industrial">
