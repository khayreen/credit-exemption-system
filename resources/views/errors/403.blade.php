...
<div class="error-container">
    <div class="error-card">
        <div class="error-code-wrapper">
            <span class="error-code-bg">403</span>
        ...
        <div class="error-details">
            ...
            <ul class="error-details-list">
                <li>
                    ...
                    <span>Your account doesn't have the required role or permissions</span>
                </li>
                <li>
                    <i class="fas fa-circle"></i>
                    <span>You're trying to access another user's private data</span>
                </li>
                <li>
                    <i class="fas fa-circle"></i>
                    <span>The resource requires administrator privileges</span>
                </li>
            </ul>
        </div>
        ...
        <div class="help-section">
            <p>If you believe you should have access, please <a href="mailto:support@uitm.edu.my">contact the administrator</a>.</p>
        </div>
    </div>
</div>
@endsection
